...
<div class="page-content container-fluid">
    <form class="form-edit-add" role="form"
            ...
            <div class="col-md-4">
                ...
                <div class="panel panel-bordered panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <img src="{{ filter_var($dataTypeContent->image()->first()->path, FILTER_VALIDATE_URL) ? $dataTypeContent->image()->first()->path : Voyager::image( $dataTypeContent->image()->first()->path ) }}"
                            style="width:100%" />
                        @endif
        ...
        <button type="submit" class="btn btn-primary pull-right">
            @if($edit){{ __('voyager::post.update') }}@else <i class="icon wb-plus-circle"></i> Update
            @endif
        </button>
        @stop
